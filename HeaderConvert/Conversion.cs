...
{
    public partial class Conversion(CppParserOptions options, string pointerAlias, string functionPointerAlias, string? includeGuardName = null)
    {
        ...
        public string Convert(List<string> files)
        {
            ...
            resultSb.AppendLine("; Generated by HeaderConvert");
            resultSb.AppendLine(".code");
            if (includeGuardName != null)
            {
                resultSb.AppendLine($"ifndef {includeGuardName}");
                resultSb.AppendLine($"{includeGuardName}:");
                resultSb.AppendLine();
            }
